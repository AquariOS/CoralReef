...
public class HWKeys extends ActionFragment implements Preference.OnPreferenceChangeListener, Indexable  {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if (!enableBacklightOptions) {
            ...
            final boolean hasVariableBrightness = getResources().getBoolean(
                    com.android.internal.R.bool.config_button_brightness_has_variable_brightness);
            if (!hasVariableBrightness) {
                mButtonBackLightCategory
                        .removePreference(findPreference("custom_button_use_screen_brightness"));
                mButtonBackLightCategory
                        .removePreference(findPreference(KEY_BUTTON_MANUAL_BRIGHTNESS_NEW));
            }
        }
